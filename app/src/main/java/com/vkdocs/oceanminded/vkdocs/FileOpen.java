...
/**
 * Created by pride on 17.02.2016.
 */
public class FileOpen {
    ...
    public static void openFile(Context context, File url) throws IOException {
        ...
        if (url.toString().contains(".doc") || url.toString().contains(".docx")) {
            ...
            // WAV audio file
            intent.setDataAndType(uri, "application/torrent");
        }
        else if(url.toString().contains(".apk")) {
            // WAV audio file
            intent.setDataAndType(uri, "android application/*");
        }
        else{
        ...
        try{
            ...
            Toast.makeText(context,"Не найдено приложение",Toast.LENGTH_LONG).show();
